...
import org.example.project.service.command.note.NoteCommandHandlerFactory;
...
public class NoteState implements DialogState{
    private final NoteCommandHandlerFactory commandHandlerFactory;
