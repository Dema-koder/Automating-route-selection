...
import org.example.project.service.command.invest.InvestCommandHandlerFactory;
...
public class InvestState implements DialogState{
    private final InvestCommandHandlerFactory commandHandlerFactory;
