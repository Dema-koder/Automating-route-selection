...
import org.example.project.service.command.gpt.GPTCommandHandlerFactory;
...
public class GPTState implements DialogState{

    private final GPTCommandHandlerFactory commandHandlerFactory;
