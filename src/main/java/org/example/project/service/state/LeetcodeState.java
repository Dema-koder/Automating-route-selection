...
import org.example.project.service.command.leetcode.LeetcodeCommandHandlerFactory;
...
public class LeetcodeState implements DialogState{

    private final LeetcodeCommandHandlerFactory commandHandlerFactory;
